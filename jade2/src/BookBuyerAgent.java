  ...
  private AID[] sellerAgents;
	...
	private class RequestPerformer extends Behaviour {
	  ...
	  public void action() {
	    ...
	    case 1:
	      ...
	      if (reply != null) {
			...
			if (repliesCnt >= sellerAgents.length || (System.currentTimeMillis() - timeInterval) >= 10000) {
	    ...
	    case 2:
	      //best proposal consumption - purchase
			if(budget >= bestPrice) {
				...
				System.out.println(getAID().getLocalName() + ": does not have the enough money to purchase " + targetBookTitle);
	  ...
	  public boolean done() {
	    ...
	    return ((step == 2 && (bestSeller == null || budgetExceeded)) || step == 4);
	  }
	}
}
